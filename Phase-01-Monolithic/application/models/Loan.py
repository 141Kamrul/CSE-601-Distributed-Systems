...
class Loan(Base):
    ...
    return_time: Optional[datetime]=Column(DateTime, nullable=True, default=None)
    status: str=Column(String(10), default="ACTIVE")
    extension_count: Optional[int]=Column(Integer, default=0)
    extended_due_time: Optional[datetime]=Column(DateTime, nullable=True, default=None)